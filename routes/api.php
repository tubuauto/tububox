...
$router->add('POST', '/api/v1/driver/deliveries/{id}/return-dispatch', [$driverController, 'returnDispatch'], [$sessionAuth, $tenantScope, $riderRole]);
...
$router->add('POST', '/api/v1/rider/deliveries/{id}/return-dispatch', [$driverController, 'returnDispatch'], [$sessionAuth, $tenantScope, $riderRole]);
